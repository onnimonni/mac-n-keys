...
class DummyCrypto: AGECrypto {
  ...
  var dummyEncapsulations: [(sharedSecret: Data, encapsulated: Data)] = [
    (
      sharedSecret: Data(base64RawEncoded: "ax1JNbXUsGHbs6DVjzcC6CrcJHOqLQKbvTjAygBf+E4")!,
      encapsulated: Data(
        base64RawEncoded:
    ...
    -> SecureEnclaveMLKEM768PrivateKey
  {
    return DummySecureEnclaveMLKEM768PrivateKey(
      key: try MLKEM768.PrivateKey(
        seedRepresentation: dummyMLKEM768SeedKeys.popLast()!, publicKey: nil))
  }
